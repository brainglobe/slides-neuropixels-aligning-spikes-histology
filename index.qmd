...
institute: Neuroinformatics Unit, Sainsbury Wellcome Centre & Gatsby Computational Neuroscience Unit, UCL.
execute: 
  enabled: true
format:
    revealjs:
...
## [Current atlases](https://brainglobe.info/documentation/brainglobe-atlasapi/index.html#atlases-available) {.smaller}
::: {style="font-size: 70%;"}
